...
(function() {
  ...
  console.log('%c🎯 BrandCoach 演示模式', 'font-size:16px;font-weight:bold;color:#E76A2C');
  console.log('所有数据为模拟数据，用于界面预览');
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      banner.innerHTML = '🎯 演示模式 · 所有数据为模拟数据 · <a href="#" style="color:white;text-decoration:underline">了解更多</a>';
